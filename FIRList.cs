...
namespace CRMS
{
    public partial class FIRList : Form
    {
        string filter = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = cn;
                cmd.CommandText = "select * from FIR where date='" + dateTimePicker1.Value.ToShortDateString() + "' ";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (go)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand();
                    cmd.Connection = cn;
                    cmd.CommandText = "select * from FIR where officerID = '" + comboBox2.Text + "' ";
                    DataTable dt = new DataTable();
                    SqlDataAdapter ad = new SqlDataAdapter(cmd);
                    ad.Fill(dt);
                    dataGridView1.DataSource = dt;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (go)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand();
                    cmd.Connection = cn;
                    cmd.CommandText = "select * from FIR where complainantID = '" + comboBox1.Text + "' ";
                    DataTable dt = new DataTable();
                    SqlDataAdapter ad = new SqlDataAdapter(cmd);
                    ad.Fill(dt);
                    dataGridView1.DataSource = dt;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (go)
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand();
                    cmd.Connection = cn;
                    cmd.CommandText = "select * from FIR where typeofcrime like '%" + comboBox3.Text + "%' ";
                    DataTable dt = new DataTable();
                    SqlDataAdapter ad = new SqlDataAdapter(cmd);
                    ad.Fill(dt);
                    dataGridView1.DataSource = dt;
        ...
        private void Submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = cn;
                cmd.CommandText = "select * from FIR where date='" + dateTimePicker1.Value.ToShortDateString() + "' and complainantID='" + comboBox1.Text + "'and  officerID='" + comboBox2.Text + "' and typeofcrime='" + comboBox3.Text + "'";
                DataTable dt = new DataTable();
                SqlDataAdapter ad = new SqlDataAdapter(cmd);
                ad.Fill(dt);
                dataGridView1.DataSource = dt;
